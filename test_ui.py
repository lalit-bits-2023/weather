...
from ui import WeatherApp  # Assuming your class is in the ui.py file
...
class TestWeatherApp(unittest.TestCase):
    ...
    def test_display_weather_success(self, mock_get_weather):
        ...
        self.assertEqual(current_weather_labels[(2, 0)].cget("text"), "Clear sky")
        ...
        self.assertEqual(forecast_labels[(5, 0)].cget("text"), "2024-10-20 09:00:00")
        self.assertEqual(forecast_labels[(5, 1)].cget("text"), "Clear sky")
        #self.assertEqual(forecast_labels[(5, 2)].cget("text"), "24.0")
        self.assertEqual(forecast_labels[(5, 2)].cget("text"), 24.0)  # Convert expected value to string
